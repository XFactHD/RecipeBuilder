...
public class ExtendedCraftingCompat
{
    ...
    {
        RecipeSerializer<?> shapedTable = ForgeRegistries.RECIPE_SERIALIZERS.getValue(new ResourceLocation(MOD_ID, "shaped_table"));
        RecipeSerializer<?> shapelessTable = ForgeRegistries.RECIPE_SERIALIZERS.getValue(new ResourceLocation(MOD_ID, "shapeless_table"));
        RecipeSerializer<?> shapedEnder = ForgeRegistries.RECIPE_SERIALIZERS.getValue(new ResourceLocation(MOD_ID, "shaped_ender_crafter"));
        RecipeSerializer<?> shapelessEnder = ForgeRegistries.RECIPE_SERIALIZERS.getValue(new ResourceLocation(MOD_ID, "shapeless_ender_crafter"));
