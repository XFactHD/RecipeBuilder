...
public class QuantumCompressorBuilder extends AbstractBuilder
{
    ...
    public static final ITextComponent TITLE_INPUT_COUNT = Utils.translate(null, "compressor.slot.input_count");
    public static final ITextComponent TITLE_POWER_COST = Utils.translate(null, "compressor.slot.power_cost");
    public static final ITextComponent TITLE_POWER_RATE = Utils.translate(null, "compressor.slot.power_rate");
    public static final ITextComponent MSG_INVALID_INPUT_COUNT = Utils.translate("msg", "compressor.slot.invalid_input_count");
    public static final ITextComponent MSG_INVALID_POWER_COST =  Utils.translate("msg", "compressor.slot.invalid_power_cost");
    public static final ITextComponent MSG_INVALID_POWER_RATE =  Utils.translate("msg", "compressor.slot.invalid_power_rate");
    ...
    private class QuantumCompressorResult implements IFinishedRecipe
    {
        ...
        @Override
        public IRecipeSerializer<?> getType() { return QuantumCompressorBuilder.this.getType(); }
