...
public class ShapedTableBuilder extends AbstractBuilder
{
    ...
    public ShapedTableBuilder(IRecipeSerializer<?> type, String itemName, String textureName, int tier, int texX, int texY, int texWidth, int texHeight)
    {
    ...
    private class ShapedTableResult implements IFinishedRecipe
    {
        ...
        public IRecipeSerializer<?> getType() { return ShapedTableBuilder.this.getType(); }
