...
public class CombinationRecipeBuilder extends AbstractBuilder
{
    ...
    public static final Component TITLE_POWER_COST = Utils.translate(null, "crafting_core.slot.power_cost");
    public static final Component TITLE_POWER_RATE = Utils.translate(null, "crafting_core.slot.power_rate");
    public static final Component MSG_INVALID_POWER_COST =  Utils.translate("msg", "crafting_core.slot.invalid_power_cost");
    public static final Component MSG_INVALID_POWER_RATE =  Utils.translate("msg", "crafting_core.slot.invalid_power_rate");
    ...
    private class CombinationResult implements FinishedRecipe
    {
        ...
        @Override
        public RecipeSerializer<?> getType() { return CombinationRecipeBuilder.this.getType(); }
